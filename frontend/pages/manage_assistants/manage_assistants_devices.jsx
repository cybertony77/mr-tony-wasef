...
export default function ManageAssistantsDevices() {
  ...
  return (
    <div className="page-wrapper" style={{ padding: "20px 5px 20px 5px" }}>
      ...
      {/* Manage Devices Modal */}
      <ManageDevicesModal
        open={isModalOpen && !!selectedAssistant}
        subject={selectedAssistant}
        subjectKind="assistant"
        isDeveloper={isDeveloper}
        allowedDevicesInput={allowedDevicesInput}
        originalAllowedDevices={originalAllowedDevices}
        onAllowedDevicesChange={setAllowedDevicesInput}
        onSave={handleSaveAllowedDevices}
        onDeleteDevice={handleDeleteDevice}
        onClose={closeManageModal}
        saving={updateAllowedDevicesMutation.isPending}
