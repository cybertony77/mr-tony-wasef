      ...
      <div className="page-content desmos-details-page" style={{ maxWidth: 800, margin: "40px auto", padding: "12px" }}>
        ...
        <div className="details-container desmos-details-container" style={{
          ...
          >
            ...
            {((mockExam?.show_overall_questions_explanation_video === true ||
              mockExam?.show_overall_questions_explanation_video === 'true') &&
              mockExam?.overall_questions_explanation_video) ? (
              <div style={{ marginTop: 16, display: 'flex', justifyContent: 'flex-start', flexWrap: 'wrap', width: '100%' }}>
                <ExplanationVideoWatchButton
                  video={mockExam.overall_questions_explanation_video}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            {questionResults.map((item, idx) => {
              ...
              return (
                ...
                >
                {({ calculatorButton }) => (
                <MathReferenceSheetAssist instanceKey={`preview-mock-${mock_exam_id}-q-${idx}-reference`} iconDark>
                {({ referenceButton }) => (
                <div
                  style={{
